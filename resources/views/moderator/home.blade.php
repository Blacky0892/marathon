...
@section('inline-buttons')
    <div class="d-inline-block me-0 float-start float-md-none">
        <a href="{{route('moderator.export', 'orders')}}" class="btn btn-primary shadow px-2" title="Экспорт" data-bs-toggle="tooltip">
...
@section('content')
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="orders-table" class="data-table col-9 hover">
                <thead>
                <tr>
                    <th>id заявки</th>
