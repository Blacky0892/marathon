...
class Stage1Export implements FromArray, WithHeadings, WithTitle, WithStyles, WithEvents
{
    private Carbon $date;
    private int $count = 3;
    ...
    {
        $result = [];
        $orders = Order::where('stage', 1)->with(['user', 'school.area'])->get();
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setWidth('H', 20);
                $event->sheet->setWidth('I', 40);
